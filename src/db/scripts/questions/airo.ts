...
const questions = [
    ...
    {
        _id: getMongoID(),
        question: 'Вывести имена пассажиров, имеющих самое длинное имя',
        database: airoDatabaseID,
    ...
    {
        _id: getMongoID(),
        question: 'Вывести количество пассажиров для всех прошедших полётов и их id',
        database: airoDatabaseID,
        answer: `select trip, count(trip) as count_p from pass_in_trip group by trip`,
        fields: ['name', 'count_p[alias]'],
        weight: 0.3,
        active: true,
        open: true,
    },
    ...
    {
        _id: getMongoID(),
        question: 'Вывести ФИО людей, фамилии которых заканчиваются на "man"',
        database: airoDatabaseID,
