...
export const questions = [
    ...
    },
    {
        ...
        database: airoDatabaseID,
        answer: "Select count(*) as count_p from airo.trip where plane='TU-134'",
        fields: ['count_p[alias]'],
        weight: 0.25,
        active: true,
        open: true,
    },
    ...
    },
    {
        ...
        database: airoDatabaseID,
        answer: `select trip, count(trip) as count_t from pass_in_trip group by trip`,
        fields: ['trip', 'count_t[alias]'],
        weight: 0.3,
        active: true,
        open: true,
    },
    {
        ...
        database: airoDatabaseID,
        answer: `select name, count(name) as count_n from passenger group by name having count_p=2`,
        fields: ['trip', 'count_n[alias]'],
        weight: 0.35,
        active: true,
        open: true,
    },
    ...
    },
    {
        ...
        database: airoDatabaseID,
        answer:
            'SELECT name, count(*) as count_n FROM passenger, trip, pass_in_trip WHERE pass_in_trip.passenger=passenger.id AND pass_in_trip.trip=trip.id GROUP BY passenger.name ORDER BY count(*) DESC',
        fields: ['name, count_n[alias]'],
        weight: 0.7,
        checkSorting: true,
        active: true,
        open: true,
